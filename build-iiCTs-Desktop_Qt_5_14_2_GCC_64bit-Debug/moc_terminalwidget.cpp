...
#include <memory>
#include "../iiCTs/include/widget/terminalwidget.h"
...
QT_MOC_LITERAL(1, 15, 16), // "processRecreated"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 9), // "QProcess*"
QT_MOC_LITERAL(4, 43, 10), // "newProcess"
QT_MOC_LITERAL(5, 54, 11), // "progressEnd"
QT_MOC_LITERAL(6, 66, 20) // "stopAndResetTerminal"

    },
    "TerminalWidget\0processRecreated\0\0"
    "QProcess*\0newProcess\0progressEnd\0"
    "stopAndResetTerminal"
};
...
void TerminalWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->processRecreated((*reinterpret_cast< QProcess*(*)>(_a[1]))); break;
        case 1: _t->progressEnd(); break;
        case 2: _t->stopAndResetTerminal(); break;
        default: ;
        }
        ...
        {
            using _t = void (TerminalWidget::*)(QProcess * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TerminalWidget::processRecreated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TerminalWidget::progressEnd)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TerminalWidget::processRecreated(QProcess * _t1)
{
...
// SIGNAL 1
void TerminalWidget::progressEnd()
{
