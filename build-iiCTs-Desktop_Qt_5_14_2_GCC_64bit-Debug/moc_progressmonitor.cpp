...
#include <memory>
#include "../iiCTs/include/mainui/progressmonitor.h"
...
QT_MOC_LITERAL(4, 39, 19), // "progressTaskStarted"
QT_MOC_LITERAL(5, 59, 4), // "name"
QT_MOC_LITERAL(6, 64, 8), // "maxValue"
QT_MOC_LITERAL(7, 73, 11), // "progressEnd"
QT_MOC_LITERAL(8, 85, 17) // "onContentsChanged"

    },
    "ProgressMonitor\0progressUpdated\0\0value\0"
    "progressTaskStarted\0name\0maxValue\0"
    "progressEnd\0onContentsChanged"
};
...
void ProgressMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->progressTaskStarted((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->progressEnd(); break;
        case 3: _t->onContentsChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProgressMonitor::*)(int );
        ...
        {
            using _t = void (ProgressMonitor::*)(const QString & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressMonitor::progressTaskStarted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ProgressMonitor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressMonitor::progressEnd)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ProgressMonitor::progressUpdated(int _t1)
{
...
// SIGNAL 1
void ProgressMonitor::progressTaskStarted(const QString & _t1, int _t2)
{
...
// SIGNAL 2
void ProgressMonitor::progressEnd()
{
