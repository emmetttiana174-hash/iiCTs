...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    if (fPolygonCount == 3){
        ...
        rotation1->rotateY(60 * CLHEP::pi / 180.0);
        ...
        rotation2->rotateY(120 * CLHEP::pi / 180.0);
        ...
        rotation4->rotateY(60 * CLHEP::pi / 180.0);
    ...
    if (fPolygonCount == 3){
        ...
        fPhysDetector = new G4PVPlacement(fRotationMatrix5, detPos, fLogicDetector, "Detector", logicWorld, false, 0, false);
        ...
        fPhysDetector1 = new G4PVPlacement(fRotationMatrix6, detPos1, fLogicDetector1, "Detector", logicWorld, false, 1, false);
        ...
        fPhysDetector2 = new G4PVPlacement(fRotationMatrix7, detPos2, fLogicDetector2, "Detector", logicWorld, false, 2, false);
...
void DetectorConstruction::SetDetectorRotationAngle2(G4double angleX, G4double angleY, G4double angleZ) {
    if (fPhysDetector1) {
        *fRotationMatrix4 = G4RotationMatrix();
        ...
        fPhysDetector1->SetRotation(fRotationMatrix4);
...
void DetectorConstruction::SetDetectorRotationAngle3(G4double angleX, G4double angleY, G4double angleZ) {
    if (fPhysDetector) {
        *fRotationMatrix5 = G4RotationMatrix();
        ...
        fRotationMatrix5->rotateY(angleY);
...
void DetectorConstruction::SetDetectorRotationAngle4(G4double angleX, G4double angleY, G4double angleZ) {
    if (fPhysDetector) {
        *fRotationMatrix6 = G4RotationMatrix();
        ...
        fRotationMatrix6->rotateY(angleY+60 * CLHEP::pi / 180.0);
...
void DetectorConstruction::SetDetectorRotationAngle5(G4double angleX, G4double angleY, G4double angleZ) {
    if (fPhysDetector) {
        *fRotationMatrix7 = G4RotationMatrix();
        ...
        fRotationMatrix7->rotateY(angleY-60 * CLHEP::pi / 180.0);
