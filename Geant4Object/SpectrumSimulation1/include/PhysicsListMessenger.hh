...
private:
  ...
  // 物理过程开关控制命令
  G4UIcmdWithAnInteger*      fIonisationCmd;        // 电离过程
  G4UIcmdWithAnInteger*      fBremsstrahlungCmd;    // 韧致辐射过程
  G4UIcmdWithAnInteger*      fScatterCmd;           // 多重散射过程
  G4UIcmdWithAnInteger*      fAnnihilationCmd;      // 正电子湮灭过程
