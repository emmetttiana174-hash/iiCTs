...
TransLinearCT::TransLinearCT(QObject *parent)
    : QObject(parent)
{
}

TransLinearCT::~TransLinearCT()
{
}

bool TransLinearCT::convertGWLToMac(const QString &gwlFilePath, const QString &macFilePath)
{
...
bool TransLinearCT::parseGWLFile(QFile *gwlFile, LinearCTGWLData &gwlData)
{
...
bool TransLinearCT::parseParameter(const QString &paramName, const QString &paramValue, LinearCTGWLData &gwlData)
{
    // 几何参数
...
bool TransLinearCT::generateMacFile(const QString &macFilePath, const LinearCTGWLData &gwlData)
{
...
bool TransLinearCT::generateVisMacFile(const QString &visFilePath, const LinearCTGWLData &gwlData)
{
...
QString TransLinearCT::generateVisMacFilePath(const QString &macFilePath)
{
    QFileInfo fileInfo(macFilePath);
...
bool TransLinearCT::generateLoopControlFile(const QString &loopFilePath, const LinearCTGWLData &gwlData)
{
