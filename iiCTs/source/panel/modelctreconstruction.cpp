...
ModelCTReconstruction::ModelCTReconstruction(QWidget* parent)
    : QWidget(parent)
{
...
void ModelCTReconstruction::resizeEvent(QResizeEvent* event)
{
    QWidget::resizeEvent(event);
}


void ModelCTReconstruction::paintEvent(QPaintEvent *event)
{
