...
ResultCTScanSimulation::ResultCTScanSimulation(QWidget *parent)
...
void ResultCTScanSimulation::setupUi()
{
    ...
    connect(modeGroup_, QOverload<int>::of(&QButtonGroup::buttonClicked),
            this, &ResultCTScanSimulation::onModeChanged);
    ...
    connect(genButton_, &QPushButton::clicked, this, &ResultCTScanSimulation::onGenClicked);
    connect(refreshButton_, &QPushButton::clicked, this, &ResultCTScanSimulation::onRefreshClicked);
    ...
    connect(axialBtn, &QPushButton::clicked, this, &ResultCTScanSimulation::onPlaneClicked);
    connect(coronalBtn, &QPushButton::clicked, this, &ResultCTScanSimulation::onPlaneClicked);
    connect(sagittalBtn, &QPushButton::clicked, this, &ResultCTScanSimulation::onPlaneClicked);
    connect(indexEdit_, &QLineEdit::editingFinished, this, &ResultCTScanSimulation::indexEditChange);
    ...
    connect(layerSlider_, &QSlider::valueChanged,
            this, &ResultCTScanSimulation::onSliderValueChanged);
    ...
    windowWidthEdit_ = new QLineEdit("60000");
    windowLevelEdit_ = new QLineEdit("30000");
    ...
    connect(windowWidthEdit_, &QLineEdit::editingFinished,
            this, &ResultCTScanSimulation::widthWinChanged);
    connect(windowLevelEdit_, &QLineEdit::editingFinished,
            this, &ResultCTScanSimulation::levelWinChanged);
    ...
    dispMinEdit_ = new QLineEdit("0");
    dispMaxEdit_ = new QLineEdit("60000");
    ...
    connect(dispMinEdit_, &QLineEdit::editingFinished,
            this, &ResultCTScanSimulation::minWinChanged);
    connect(dispMaxEdit_, &QLineEdit::editingFinished,
            this, &ResultCTScanSimulation::maxWinChanged);
    ...
    connect(flipVertButton_, &QPushButton::clicked,
            this, &ResultCTScanSimulation::onFlipVert);
    connect(flipHorzButton_, &QPushButton::clicked,
            this, &ResultCTScanSimulation::onFlipHorz);
    connect(rotateCWButton_, &QPushButton::clicked,
            this, &ResultCTScanSimulation::onRotateCW);
    connect(rotateCCWButton_, &QPushButton::clicked,
            this, &ResultCTScanSimulation::onRotateCCW);
...
void ResultCTScanSimulation::onProjectInfoChanged(const ProjectInfo &info)
{
    allInfo = info;
}

void ResultCTScanSimulation::scriptCTChanged(const QString &filePath)
{
    scriptCT_ = filePath;
    scriptCTs = parseVariableFile(filePath);

    volumeFolder_ = getVariableValue(scriptCTs, "OutputPath");
    volumeFileBase_ = getVariableValue(scriptCTs, "OutputFilename");
    QString detectorScript_ = getVariableValue(scriptCTs, "DetectorPath");
    detectorScripts = parseVariableFile(detectorScript_);

    dimH_ = getVariableValue(detectorScripts, "DetCountX").toInt();
    dimW_ = getVariableValue(detectorScripts, "DetCountY").toInt();
}

void ResultCTScanSimulation::scriptChanged(const QString &filePath)
{
    script_ = filePath;
    scripts = parseVariableFile(filePath);
}

bool ResultCTScanSimulation::readVolumeFile()
{
    qDebug() << ">>> Loading data...";
...
void ResultCTScanSimulation::setMainWindow(MainWindow *main)
{
    mainWindow = main;
}

bool ResultCTScanSimulation::generateVolume()
{
    QProcess proc;
    QStringList args;
    ...
    if (!proc.waitForFinished(-1) || proc.exitStatus() != QProcess::NormalExit)
    {
        ...
        showStyledWarning(this, "Gen Error", "Generation script failed to run.");
        return false;
    }
    return readVolumeFile();
}

void ResultCTScanSimulation::updateSliderRange()
{
    int maxLayer = 1;
...
void ResultCTScanSimulation::updateImageDisplay()
{
    if (volume_.isEmpty())
        return;
...
void ResultCTScanSimulation::onModeChanged(int id)
{
    suffix_ = (id == 0 ? ".ai.raw" : ".raw");
}

void ResultCTScanSimulation::onGenClicked()
{
    if (generateVolume())
        showStyledWarning(this, "Success", "Volume generated.");
}

void ResultCTScanSimulation::onRefreshClicked()
{
    if (readVolumeFile())
        showStyledWarning(this, "Refreshed", "Volume reloaded.");
}

void ResultCTScanSimulation::onPlaneClicked()
{
...
void ResultCTScanSimulation::indexEditChange()
{
    bool ok;
...
void ResultCTScanSimulation::onSliderValueChanged(int v)
{
    currentLayer_ = v;
...
void ResultCTScanSimulation::maxWinChanged()
{
...
void ResultCTScanSimulation::minWinChanged()
{
    QString maxStr = dispMaxEdit_->text().trimmed();
    QString minStr = dispMinEdit_->text().trimmed();
    bool okDispMax = false;
...
void ResultCTScanSimulation::levelWinChanged()
{
    QString levelStr = windowLevelEdit_->text().trimmed();
    QString widthStr = windowWidthEdit_->text().trimmed();
    bool okLevel = false;
...
void ResultCTScanSimulation::widthWinChanged()
{
    QString levelStr = windowLevelEdit_->text().trimmed();
    QString widthStr = windowWidthEdit_->text().trimmed();
    bool okLevel = false;
...
void ResultCTScanSimulation::onRange()
{
    if (volume_.isEmpty())
        return;
...
void ResultCTScanSimulation::onFlipVert()
{
    transform_.scale(1, -1);
    updateImageDisplay();
}

void ResultCTScanSimulation::onFlipHorz()
{
    transform_.scale(-1, 1);
    updateImageDisplay();
}

void ResultCTScanSimulation::onRotateCW()
{
    transform_.rotate(90);
    updateImageDisplay();
}

void ResultCTScanSimulation::onRotateCCW()
{
    transform_.rotate(-90);
    updateImageDisplay();
}

void ResultCTScanSimulation::onResetTransform()
{
    transform_.reset();
    updateImageDisplay();
}

void ResultCTScanSimulation::resizeEvent(QResizeEvent *event)
{
...
void ResultCTScanSimulation::paintEvent(QPaintEvent *event)
{
...
QVector<VariableEntry> ResultCTScanSimulation::parseVariableFile(const QString &filePath)
{
...
QString ResultCTScanSimulation::getVariableValue(const QVector<VariableEntry> &variables, const QString &name)
{
...
void ResultCTScanSimulation::showStyledWarning(QWidget *parent, const QString &titleText, const QString &messageText)
{
