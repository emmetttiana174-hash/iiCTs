...
ModelVersionInformation::ModelVersionInformation(QWidget* parent)
    : QWidget(parent)
{
...
void ModelVersionInformation::resizeEvent(QResizeEvent* event)
{
    QWidget::resizeEvent(event);
}


void ModelVersionInformation::paintEvent(QPaintEvent *event)
{
