...
ResultVersionInformation::ResultVersionInformation(QWidget* parent)
    : QWidget(parent)
{
...
void ResultVersionInformation::resizeEvent(QResizeEvent* event)
{
    QWidget::resizeEvent(event);
}


void ResultVersionInformation::paintEvent(QPaintEvent *event)
{
