#ifndef PARADETECTORMODEL_H
#define PARADETECTORMODEL_H
...
class ParaDetectorModel : public QWidget
{
    Q_OBJECT
public:
    explicit ParaDetectorModel(QWidget *parent = nullptr);
