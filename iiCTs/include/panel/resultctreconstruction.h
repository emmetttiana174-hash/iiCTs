#ifndef RESULTCTRECONSTRUCTION_H
#define RESULTCTRECONSTRUCTION_H
...
class ResultCTReconstruction : public QWidget {
    Q_OBJECT

public:
    explicit ResultCTReconstruction(QWidget* parent = nullptr);
...
#endif // RESULTCTRECONSTRUCTION_H
