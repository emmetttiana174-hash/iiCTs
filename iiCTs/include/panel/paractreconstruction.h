#ifndef PARACTRECONSTRUCTION_H
#define PARACTRECONSTRUCTION_H
...
class ParaCTReconstruction : public QWidget
{
    Q_OBJECT
public:
    explicit ParaCTReconstruction(QWidget *parent = nullptr);
