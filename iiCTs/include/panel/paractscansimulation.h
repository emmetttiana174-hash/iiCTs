#ifndef PARACTSCANSIMULATION_H
#define PARACTSCANSIMULATION_H
...
class TransHelicalCT;
class TransCBCT;
class TransLinearCT;
class PolygonIntervalCT;
class TransPolygonSideCT;

class ParaCTScanSimulation : public QWidget
{
    Q_OBJECT
public:
    explicit ParaCTScanSimulation(QWidget *parent = nullptr);
...
private:
    ...
    // GWL转换器
    TransHelicalCT *helicalConverter;
    TransCBCT *cbctConverter;
    TransLinearCT *linearConverter;
    PolygonIntervalCT *polygonIntervalConverter;
    TransPolygonSideCT *polygonSideConverter;
